...
-- Add color and role columns to lembretes
ALTER TABLE public.lembretes ADD COLUMN IF NOT EXISTS cor text DEFAULT 'blue';
ALTER TABLE public.lembretes ADD COLUMN IF NOT EXISTS criado_por_role text DEFAULT 'usuario';